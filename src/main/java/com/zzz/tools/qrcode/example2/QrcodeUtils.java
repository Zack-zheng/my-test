package com.zzz.tools.qrcode.example2;
...
import com.zzz.tools.qrcode.example1.BufferedImageLuminanceSource;
...
//        FolderUtils.mkdirs(destFile.getParent());
    ...
    public static void main(String[] args) throws Exception {
        String text = "http://www.baidu.com?adfkadhajdhfds= sdfjahdfasdj;kfhadsfapdfiaudf";
        QrcodeUtils.gen(text, "J:/123.png","J:/shopping.png");

        System.out.println(parse("J:/123.png"));
    }
}
